...
ryz = 4
scratch = 2
path = '/scratch0{0}.local/falvarez/Kflow/forcing_control/merged_high_reynolds/ryz{1}'.format(scratch,ryz)
...
def main():
    Reynolds1 =np.logspace(5,8,num=32,base=2.0)
    Reynolds2 =np.logspace(8,10,num=32,base=2.0)
    Reynolds = np.union1d(Reynolds1, Reynolds2)
   ...
   # ax.set_xscale('log')
    ...
    fig.savefig('RevsA_raw_merged_high_reynolds_scratch0{0}_ryz{1}.png'.format(scratch, ryz), format='png')
    return 0
