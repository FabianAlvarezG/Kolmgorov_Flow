...
#plt.ylim((0,1.2))
ax.plot(Reynolds, amplitudes_0,'--', color='red',marker='s',label=r'$|\langle \psi_0 | \phi \rangle |$')
ax.plot(Reynolds, amplitudes_a0,'--', color='blue', marker='s',label=r'$|\langle \psi_\alpha | \phi \rangle |$')
...
fig.savefig('RevsA_raw_stress_projection_detailed_high_reynolds_scratch0{0}_ryz{1}.png'.format(scratch, ryz), format='png')
