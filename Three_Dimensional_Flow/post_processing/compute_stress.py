...
for i,f in enumerate(forcing_amplitudes):
    ...
    if path_h5_file in file:
        ...
        vor3Dr = np.fft.irfftn(vor3Dk, axes=(0,1,2))*nx*ny
        vel3Dr = np.fft.irfftn(vel3Dk, axes=(0,1,2))*nx*ny
        ...
        tau_xx =np.fft.irfftn(phi_xx[0,...], axes=(0,1))
        tau_yy =np.fft.irfftn(phi_yy[0,...], axes=(0,1))
        tau_zz =np.fft.irfftn(phi_zz[0,...], axes=(0,1))
        tau_xy =np.fft.irfftn(phi_xy[0,...], axes=(0,1))
        tau_zx =np.fft.irfftn(phi_zx[0,...], axes=(0,1))
        tau_yz =np.fft.irfftn(phi_yz[0,...], axes=(0,1))
