...
class simulator(TurTLE.DNS):
    def write_src(
        ...
        self.definitions += open(
                os.path.join(
                    cpp_location, 'NSVE_filtered_DB_zaverage.cpp'), 'r').read()
    ...
    def generate_default_parameters(self):
        ...
        self.parameters['nu'] = float(0.00155)
        self.parameters['fmode'] = int(1)
        self.parameters['famplitude'] = float(0.5)
        self.parameters['friction_coefficient'] = float(0.0)
        self.parameters['energy'] = float(0.5)
        self.parameters['injection_rate'] = float(0.4)
        self.parameters['fk0'] = float(0)
        self.parameters['fk1'] = float(0.999)
        self.parameters['forcing_type'] = 'Kolmogorov_and_drag'
        ...
        self.parameters['ny_DB'] = self.parameters['ny']
        self.parameters['nz_DB'] = 1
    ...
    def add_parser_arguments(
        ...
        parser.add_argument(
                ...
                type = str,
                dest = 'DNS_class',
                choices = ['NSVE_filtered_DB_zaverage'],
                default = 'NSVE_filtered_DB_zaverage')
        return None
