import os
import h5py
from simulator_averagey import simulator
from TurTLE import host_info
import getpass

from simulator_averagey import username, homefolder, hostname
...
def launch(
    ...
    print(base_dir)
    work_dir = os.path.join(base_dir, 'N{0:0>4d}_averagey'.format(N))
    args += ['--wd', work_dir]
...
if __name__ == '__main__':
    launch(ratio_yz = 1,niterations = '512')
