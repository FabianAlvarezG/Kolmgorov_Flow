...
## Saving directories
scratch = 4
simname = 'N{0:0>4d}_rxy{1}_famplitude_{2:.3f}'.format(N, rxy,famplitude)
base_dir = '/scratch0{0}.local/falvarez/Kflow/2D/'.format(scratch)
work_dir = os.path.join(base_dir, 'N{0:0>4d}_rxy{1}_famplitude_{2:.3f}'.format(N, rxy,famplitude))
...
sim = Kolmogorov2D(a, R, N,wi=wk, mu=mu)
## Simulate
